...
def extract_relations(doc, spanbert, entities_of_interest=None, conf=0.7, r=2):
    ...
    for sentence in doc.sents:
        ...
        # print('\nentity of interest: ', entities_of_interest) ####
        entity_pairs = create_entity_pairs(sentence, entities_of_interest)
        # print('\tEntity pairs: ', entity_pairs, '\n')   ####

        if not entity_pairs:
            # print('\n Skip empty entity pairs: \n')  ####
            continue
        
        examples = []
        for ep in entity_pairs:
            # Schools_Attended or Works_For
            if r ==1 or r == 2:
            ...
            # Live_In
                ...
                elif ep[1][1] in ["LOCATION", "CITY", "STATE_OR_PROVINCE", "COUNTRY"] and ep[2][1] == 'PERSON':
                    examples.append({"tokens": ep[0], "subj": ep[2], "obj": ep[1]})
